function loading() {
    ...
    const array = JSON.parse(localStorage.getItem('arrayCasa')) || [];
    let htmlContent = '';
...
function calcularOrcamento(){
    ...
    if(localStorage.arrayCasa){
        array = JSON.parse(localStorage.getItem('arrayCasa'))
    }
    ...
    localStorage.arrayCasa = JSON.stringify(array);

    resposta.innerHTML = localStorage.arrayCasa;
    loading()
